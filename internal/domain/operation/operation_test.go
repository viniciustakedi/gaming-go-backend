...
func TestCatalogClassifiesEveryStableCode(t *testing.T) {
	...
	tests := []struct {
		...
		{operation.CodeInvalidRequest, operation.Correctable}, {operation.CodeInvalidMoney, operation.Correctable}, {operation.CodeUnsupportedCurrency, operation.Correctable}, {operation.CodeInvalidAmountForKind, operation.Correctable}, {operation.CodeKindNotAllowed, operation.Correctable}, {operation.CodeMissingIdempotencyKey, operation.Correctable}, {operation.CodeReferenceRequired, operation.Correctable}, {operation.CodeReferenceNotAllowed, operation.Correctable}, {operation.CodeWalletNotFound, operation.Correctable}, {operation.CodeTransactionNotFound, operation.Correctable}, {operation.CodeWalletPlayerMismatch, operation.Correctable}, {operation.CodeWalletCurrencyMismatch, operation.Correctable},
